  ...
  return (
    <div>
        ...
        <div className='project-row2'>
            <a className="card" data-aos="fade-up" data-aos-delay="250" href="/External-Links/Glass/index.html" target='_blank'><img src="/External-Links/Thumbnails/Screenshot (92).png" alt="" className='Project-Thumb' /></a>
            <a className="card" data-aos="fade-up" data-aos-delay="250" href="/External-Links/Simple-Calculator/index.html" target='_blank'><img src="/External-Links/Thumbnails/Screenshot (99).png" alt="" className='Project-Thumb' /></a>
        ...
        <div className='project-row3'>
            ...
            <a className="card" data-aos="fade-up" data-aos-delay="350" href="/External-Links/Doodle-Jump/index.html" target='_blank'><img src="/External-Links/Thumbnails/Screenshot (90).png" alt="" className='Project-Thumb' /></a>
            <a className="card" data-aos="fade-up" data-aos-delay="350" href="/External-Links/Candy-Crush/candy.html" target='_blank'><img src="/External-Links/Thumbnails/Screenshot (89).png" alt="" className='Project-Thumb' /></a>
        </div>
    </div>
  );
};
